		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 subscribe-main footer-grid-agileits-w3ls text-left">
					<h2>Signup for ward newsletter</h2>
			...
			<div class="footer-cpy text-center">
				...
				<div class="w3layouts-agile-copyrightbottom">
					<p> Sitatunga Ward Site | Developed by
						<a href="https://cmg-ict-solutions.business.site/">CMG Technologies</a><br>
						&copy<?php $current=date("Y"); print_r($current);?>
