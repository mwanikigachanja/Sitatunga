...
<html lang="en">
  <head>
    ...
    <title><?php echo ucwords('WARD ADMIN'); ?> | <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
    <!-- Bootstrap core CSS -->
  ...
  <!-- Sidebar -->
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">WARD ADMIN</a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="blogs_view.php"><i class="fa fa-rss"></i>Posts</a></li>
         ...
         <ul class="nav navbar-nav navbar-right navbar-user">
            <li class="dropdown messages-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <i class="fa fa-envelope"></i> Messages <span class="badge">7</span> 
                <b class="caret"></b></a>
              <ul class="dropdown-menu">
                ...
                <li class="message-preview">
                  <a href="#">
                    ...
                    <span class="name">Ward Panel:</span>
                    <span class="message">Hey Admin, kindly share the bursaries final list...</span>
                ...
                <li class="message-preview">
                  <a href="#">
                    <span class="avatar"><img src="http://placehold.it/50x50"></span>
                    <span class="name">Hon Simon Murei:</span>
                    <span class="message">Hey Admin, I'm yet to see the final bursaries list. Kindly post immediately.</span>
                    <span class="time"><i class="fa fa-clock-o"></i> 4:34 PM</span>
                  </a>
                </li>
                <li class="divider"></li>
                <li class="message-preview">
                  <a href="#">
                    <span class="avatar"><img src="http://placehold.it/50x50"></span>
                    <span class="name">Dr Koech</span>
                    <span class="message">Hey Admin, when is the MCA around? We have a few bones to pick with him on matters healthcare 
                      in the ward. Kindly let me know if I can schedule an appointment with my leader soon.</span>
                    <span class="time"><i class="fa fa-clock-o"></i> 4:34 PM</span>
                  </a>
                </li>
                <li class="divider"></li>
